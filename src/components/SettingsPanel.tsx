  ...
  return (
    ...
    >
      <div className='w-full space-y-4'>
        <div className='relative text-center font-medium text-muted-foreground text-sm'>
          Settings
          {(isLoading || isUpdating) && (
            <Loader2 className='absolute top-0.5 left-43 size-4 animate-spin text-foreground' />
          )}
        </div>
